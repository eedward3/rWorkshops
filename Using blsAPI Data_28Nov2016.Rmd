...
[i,] represents i as the rows and the columns open for each variable the code will loop through. The square brackets are used to subset vectors and data frames.
